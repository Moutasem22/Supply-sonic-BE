...
namespace IServiceContractor
{
    public interface IAuthenticationService
    {
        ...
        ResultViewModel<UserInfo> Verify(string verificationCode, IEnumerable<Claim> claims, string RemoteIpAddress);
        ...
        ResultViewModel<UserInfo> ResendOTP(string Token);
