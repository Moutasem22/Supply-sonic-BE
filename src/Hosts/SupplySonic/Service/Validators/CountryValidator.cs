...
public class CountryValidator : AbstractValidator<CountryAddEditDto>
{
    private readonly IBaseService baseService;
    public CountryValidator(IBaseService baseService)
    {
    ...
    private bool IsExistName(CountryAddEditDto dto, string name)
    {
        var exist = baseService.Context.Countries.AsNoTracking().FirstOrDefault(n => n.IsActive && !n.IsDeleted && n.Id != dto.Id
