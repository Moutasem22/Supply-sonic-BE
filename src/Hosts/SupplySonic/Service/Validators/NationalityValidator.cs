...
public class NationalityValidator : AbstractValidator<NationalityAddEditDto>
{
    private readonly IBaseService baseService;
    public NationalityValidator(IBaseService baseService)
    {
    ...
    private bool IsExistName(NationalityAddEditDto dto, string name)
    {
        var exist = baseService.Context.Nationalities.AsNoTracking().FirstOrDefault(n => n.IsActive && !n.IsDeleted && n.Id != dto.Id
