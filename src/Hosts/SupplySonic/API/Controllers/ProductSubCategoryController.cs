...
namespace AppAPI.Controllers
{
    ...
    public class ProductSubCategoryController : ControllerBase
    {
        ...
        public ProductSubCategoryController(IProductSubCategoryService __Service)
        {
            _service = __Service;
        }

        [HttpPost("Add")]
        public async Task<IActionResult> Add([System.Web.Http.FromBody] ChildLockupResultDto lockupDto)
        {
        ...
        public async Task<IActionResult> GetAllWithSubs(int CategoryId)
        {
            var val = await _service.GetAllByCategoryId(CategoryId);
            return Ok(val);
        }
