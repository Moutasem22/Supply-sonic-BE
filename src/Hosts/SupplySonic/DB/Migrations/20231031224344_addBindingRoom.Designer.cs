...
namespace DB.Migrations
{
    ...
    [Migration("20231031224344_addBindingRoom")]
    partial class addBindingRoom
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Models.BindingRoom", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("BindingRoomStatus")
                        .HasColumnType("int");
                    ...
                    b.ToTable("BindingRooms");
                });

            modelBuilder.Entity("Core.Models.BindingRoomAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("BindingRoomId");

                    b.ToTable("BindingRoomAttachments");
                });

            modelBuilder.Entity("Core.Models.BindingRoomAttribute", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("BindingRoomAttributess");
                });

            modelBuilder.Entity("Core.Models.BindingRoomRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Models.Products.Attribute", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Models.Products.ProductAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Models.Products.ProductAttribute", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Models.Products.ProductMainCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Models.Products.ProductOffer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Models.Products.ProductOfferAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ProductOfferAttachments");
                });

            modelBuilder.Entity("Core.Models.Products.ProductOfferAttribute", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ProductOfferAttributes");
                });

            modelBuilder.Entity("Core.Models.Products.ProductOfferPriceSchedule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("QuantityOption1From")
                        .HasColumnType("int");

                    b.Property<int>("QuantityOption1To")
                        .HasColumnType("int");

                    b.Property<double>("QuantityOption1UnitPrice")
                        .HasColumnType("float");

                    b.Property<int?>("QuantityOption2From")
                        .HasColumnType("int");

                    b.Property<int?>("QuantityOption2To")
                        .HasColumnType("int");

                    b.Property<double?>("QuantityOption2UnitPrice")
                        .HasColumnType("float");

                    b.Property<int?>("QuantityOption3From")
                        .HasColumnType("int");

                    b.Property<int?>("QuantityOption3To")
                        .HasColumnType("int");

                    b.Property<double?>("QuantityOption3UnitPrice")
                        .HasColumnType("float");
                    ...
                    b.ToTable("ProductOfferPriceSchedules");
                });

            modelBuilder.Entity("Core.Models.Products.ProductSubCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Models.Products.ProductWeight", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<double>("LoadingQuantity")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("Core.Models.Products.SubAttribute", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Models.Products.Unit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Models.BindingRoom", b =>
                {
                    b.HasOne("Core.Models.Products.ProductMainCategory", "ProductMainCategory")
                        .WithMany()
                        .HasForeignKey("ProductMainCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Core.Models.Products.ProductSubCategory", "ProductSubCategory")
                        .WithMany()
                        .HasForeignKey("ProductSubCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Core.Models.Identity.SupplierAppUser", "SupplierAppUser")
                        .WithMany()
                        .HasForeignKey("SupplierAppUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Core.Models.Products.Unit", "UOM")
                        .WithMany()
                        .HasForeignKey("UOMId");
            ...
            modelBuilder.Entity("Core.Models.BindingRoomAttachment", b =>
                {
                    ...
                    b.HasOne("Core.Models.BindingRoom", "BindingRoom")
                        .WithMany("BindingRoomAttachments")
                        .HasForeignKey("BindingRoomId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Attachment");

                    b.Navigation("BindingRoom");
                });

            modelBuilder.Entity("Core.Models.BindingRoomAttribute", b =>
                {
                    b.HasOne("Core.Models.Products.Attribute", "Attribute")
                        .WithMany()
                    ...
                    b.HasOne("Core.Models.BindingRoom", "BindingRoom")
                        .WithMany("BindingRoomAttributes")
                        .HasForeignKey("BindingRoomId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Core.Models.Products.SubAttribute", "SubAttribute")
                        .WithMany()
            ...
            modelBuilder.Entity("Core.Models.Order", b =>
                {
                    ...
                    b.HasOne("Core.Models.UserAddress", "UserAddress")
                        .WithMany()
            ...
            modelBuilder.Entity("Core.Models.OrderDetails", b =>
                {
                    ...
                    b.HasOne("Core.Models.Products.ProductOffer", "ProductOffer")
                        .WithMany()
            ...
            modelBuilder.Entity("Core.Models.Products.ProductOfferAttachment", b =>
                {
                    ...
                    b.HasOne("Core.Models.Products.ProductOffer", "ProductOffer")
                        .WithMany("ProductOfferAttachments")
                        .HasForeignKey("ProductOfferId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Core.Models.Products.ProductOfferAttribute", b =>
                {
                    ...
                    b.HasOne("Core.Models.Products.ProductOffer", "ProductOffer")
                        .WithMany("ProductOfferAttributes")
                        .HasForeignKey("ProductOfferId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Core.Models.Products.ProductOfferPriceSchedule", b =>
                {
                    b.HasOne("Core.Models.Products.ProductOffer", "ProductOffer")
                        .WithMany("ProductOfferPriceSchedules")
                        .HasForeignKey("ProductOfferId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Core.Models.Products.ProductWeight", b =>
                {
                    b.HasOne("Core.Models.Products.Unit", "LoadingUnit")
                        .WithMany()
                        .HasForeignKey("LoadingUnitId");

                    b.HasOne("Core.Models.Products.Unit", "MOQUnit")
                        .WithMany()
                        .HasForeignKey("MOQUnitId");

                    b.HasOne("Core.Models.Products.Unit", "PackingUnit")
                        .WithMany()
                    ...
                    b.HasOne("Core.Models.Products.Unit", "ProductionUnit")
                        .WithMany()
            ...
            modelBuilder.Entity("Core.Models.BindingRoom", b =>
                {
                    b.Navigation("BindingRoomAttachments");

                    b.Navigation("BindingRoomAttributes");

                    b.Navigation("BindingRoomRequests");
                });
            ...
            modelBuilder.Entity("Core.Models.Products.ProductOffer", b =>
                {
                    b.Navigation("ProductOfferAttachments");

                    b.Navigation("ProductOfferAttributes");

                    b.Navigation("ProductOfferPriceSchedules");
                });
