        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SubAttributes_Attributes_AttributeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SecondDescriptionEn = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SecondDescriptionAr = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_ProductMainCategories_ProductMainCategoryId",
                        column: x => x.ProductMainCategoryId,
                        principalTable: "ProductMainCategories",
                        principalColumn: "Id",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Products_SupplierAppUsers_SupplierId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductAttributes_SubAttributes_SubAttributeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductAttributes_SubAttributeId",
                table: "ProductAttributes",
                column: "SubAttributeId");

            migrationBuilder.CreateIndex(
                name: "IX_Products_ProductMainCategoryId",
                table: "Products",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubAttributes_AttributeId",
                table: "SubAttributes",
                column: "AttributeId");
        }
